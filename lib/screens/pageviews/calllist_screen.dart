...
class Call_List_Screen extends StatefulWidget {
  const Call_List_Screen({ Key? key }) : super(key: key);

  @override
  _Call_List_ScreenState createState() => _Call_List_ScreenState();
}

class _Call_List_ScreenState extends State<Call_List_Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: QuietBox(heading: "Coming Soon",subtitle: "Features to unable voice and video calling, meanwhile chat with freedom!",),),
    );
  }
